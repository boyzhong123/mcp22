...
export const DICT: Record<string, string> = {
  ...
  'Calls left': '剩余次数',
  'Calls remaining': '剩余次数',
  'Calls purchased': '购买次数',
  'Per call': '单价',
  Tier: '档位',
  'Current rate': '当前单价',
  'Volume discount applied': '已应用阶梯优惠',
  'Volume tiers · flat per-call rate': '阶梯价 · 整笔按档位单价',
  'Pick a quantity above to see your price.': '在上方选择次数后会显示总价。',
  'Or enter a custom number of calls': '或输入自定义次数',
  'Per-call pricing': '按次定价',
  Standard: '标准价',
  Volume: '批量价',
  Bulk: '大批量价',
  Example: '示例',
  'Calls per top-up': '单次充值次数',
  calls: '次',
